...
$fln = Database::getInstance()->select_from_where2('SecurityStaffs','email',$myemail);
foreach ($fln as $fn) {
   $fullname = $fn['lastName'].' '.$fn['middleName'].' '.$fn['firstName'];
   $security_id = $fn['id'];
   $_SESSION['userSession'] = $security_id;
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo Database::getInstance()->count_for_d($security_id,10,'security_id'); ?></p>
                      <!-- <p>10.00% (30 days)</p> -->
                    </div>
                  </div>
                </div>
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo Database::getInstance()->count_for_d($security_id,1,'security_id'); ?></p>
                      <!-- <p>22.00% (30 days)</p> -->
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo Database::getInstance()->count_for_d($security_id,2,'security_id'); ?></p>
                      <!-- <p>2.00% (30 days)</p> -->
                    </div>
                  </div>
                </div>
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo Database::getInstance()->count_for_d($security_id,0,'security_id'); ?></p>
                      <!-- <p>0.22% (30 days)</p> -->
                    </div>
                  </div>
                </div>
