...
if(!isset($_SESSION['userSession'])){
  ...
  $myemail = Database::getInstance()->get_name_from_id('email','SecurityStaffs','id',$user_id);
}
?>
<!DOCTYPE html>
<html lang="en">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="signup">
                    <?php 
                        $users = Database::getInstance()->select_from_where2('SecurityStaffs','email',$myemail);
		...
		a('#signup').on('submit', function (e) {
			e.preventDefault();
				a.ajax({
					type: 'POST',
					url: '../func/edit.php',
					data: a('#signup').serialize() + '&ins=editStaff&val=<?php echo $user_id; ?>&table=SecurityStaffs',
