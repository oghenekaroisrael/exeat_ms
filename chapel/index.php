...
$fln = Database::getInstance()->select_from_where2('ChapelStaffs','email',$myemail);
foreach ($fln as $fn) {
   $fullname = $fn['lastName'].' '.$fn['middleName'].' '.$fn['firstName'];
   $chapel_id = $fn['id'];
   $_SESSION['userSession'] = $chapel_id;
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo Database::getInstance()->count_for_d($chapel_id,10,'chapel_id'); ?></p>
                      <!-- <p>10.00% (30 days)</p> -->
                    </div>
                  </div>
                </div>
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo Database::getInstance()->count_for_d($chapel_id,1,'chapel_id'); ?></p>
                      <!-- <p>22.00% (30 days)</p> -->
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo Database::getInstance()->count_for_d($chapel_id,2,'chapel_id'); ?></p>
                      <!-- <p>2.00% (30 days)</p> -->
                    </div>
                  </div>
                </div>
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo Database::getInstance()->count_for_d($chapel_id,0,'chapel_id'); ?></p>
                      <!-- <p>0.22% (30 days)</p> -->
                    </div>
                  </div>
                </div>
