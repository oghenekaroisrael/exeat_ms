              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <button type="button" class="btn btn-success" onclick="approve(<?php echo $app_id; ?>);">Approve</button>
                    <button type="button" class="btn btn-danger"  onclick="decline(<?php echo $app_id; ?>);">Decline</button>
 ...
 <script type="text/javascript">
        ...
        function approve(app_id) {
            a.ajax({
					type: 'POST',
					url: '../func/verify.php',
					data: 'ins=alterStatus&status=1&app_id='+app_id+'&user='+user,
        ...
        function decline(app_id) {
            a.ajax({
					type: 'POST',
					url: '../func/verify.php',
					data: 'ins=alterStatus&status=2&app_id='+app_id+'&user='+user,
					success: function(response)
					{
                        if (response === 'Done') {
                            window.location.href = 'Applications?status=changed';
